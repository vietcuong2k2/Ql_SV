    ...
    <header class="flex items-center justify-between px-6 py-3 bg-white border-b border-gray-200">
        <div class="flex items-center space-x-6">
            ...
            <nav class="hidden sm:flex space-x-6 text-sm text-[#475569] font-normal">
                <a href="dashboard.php" class="hover:text-black">Trang chủ</a>
                <a href="student_manage.php" class="hover:text-black">Quản lý sinh viên</a> <!-- Đã thay đổi đường dẫn -->
                <a href="../class-management/index.php" class="hover:text-black">Quản lý lớp học</a>
